...
export async function GET() {
  const envVars = {
    ...
    AWS_AMPLIFY_CREDENTIAL_LISTENER_ENABLED: process.env.AWS_AMPLIFY_CREDENTIAL_LISTENER_ENABLED,
    AWS_AMPLIFY_CREDENTIAL_LISTENER_HOST: process.env.AWS_AMPLIFY_CREDENTIAL_LISTENER_HOST,
    AWS_AMPLIFY_CREDENTIAL_LISTENER_PATH: process.env.AWS_AMPLIFY_CREDENTIAL_LISTENER_PATH,
    AWS_AMPLIFY_CREDENTIAL_LISTENER_PORT: process.env.AWS_AMPLIFY_CREDENTIAL_LISTENER_PORT,
  };
