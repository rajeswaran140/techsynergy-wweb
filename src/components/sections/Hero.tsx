...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Left — CTA */}
      <div className="relative flex items-center justify-center bg-linear-to-br from-slate-100 via-slate-200 to-blue-100 dark:from-slate-950 dark:via-slate-950 dark:to-slate-950 overflow-hidden">
